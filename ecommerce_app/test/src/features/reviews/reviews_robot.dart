...
class ReviewsRobot {
  ...
  void expectFindOneReview() {
    //don't skip offstage widgets as the product reviews may appear below the visible area on screen
  ...
  //leave a review
  Future<void> enterReviewScore() async {
